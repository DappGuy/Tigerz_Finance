    ...
    return (
      <div className={classes.root}>
        <Typography variant={'h5'} className={classes.disclaimer}>
          Stake LP Tokens and earn TIGZ for FREE!!
        </Typography>
    ...
    return (
      <div className={classes.rewardPoolContainer} key={rewardPool.id}>
        ...
        <Typography varian="h4" className={classes.contractLabel} align="center">
          Contract Address:
          <a href={`https://explorer-mainnet.maticvigil.com/address/${addy}`} target="_blank" rel="noopener noreferrer" className={classes.contractAddress}>
            {` ${address}`}
          </a>
        </Typography>
        <Button
